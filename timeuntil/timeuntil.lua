...
local serverEvents = {
	...
	[eventsName[locale].Lusca] = {
		times = { { hour = 12, minute = 20, duration = 30 } },
		days = { 1, 2, 3, 4, 5, 6, 7 },
	},
	...
	[eventsName[locale].RD] = {
		{
			times = {
				{ hour = 2, minute = 00, duration = 15 },
				{ hour = 10, minute = 30, duration = 15 },
				{ hour = 20, minute = 00, duration = 15 },
			},
			days = { 1, 2, 4, 6 },
		},
	},
	[eventsName[locale].Abyssal_Atk] = {
		{
			times = { { hour = 12, minute = 00, duration = 30 }, { hour = 22, minute = 30, duration = 30 } },
			days = { 3, 5, 7 },
		},
	},
	...
	[eventsName[locale].Prairie] = {
		{
			times = { { hour = 9, minute = 00, duration = 20 }, { hour = 22, minute = 00, duration = 20 } },
			days = {
				6,
				7,
			},
